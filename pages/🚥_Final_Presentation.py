...
with tab2:
     ...
     + Presenter should record his/her own presentation using a smart device for submission (youtube link)
     + Requirements:
       1. Visual material should be ready.
       2. Duration: 3 mins (+/- 10 sec.)
