...
@st.cache_data
def load_data():
    return pd.read_csv("https://raw.githubusercontent.com/MK316/Engpro-Class/refs/heads/main/pages/cefr_20260208a.csv")
...
# Create tabs
tab1, tab2, tab3, tab4, tab5 = st.tabs(["🔤 Search by Word", "🌀 Monophthongs", "🌀 Diphthongs", "🐥 Practice", "🌈 Quiz taking"])
