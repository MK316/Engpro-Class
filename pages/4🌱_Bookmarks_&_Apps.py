...
def main():
    ...
    # Create tabs
    tab1, tab2, tab3, tab4, tab5, tab6 = st.tabs(["🔆 Weblinks", "🌈 Oxford5K", " 🔆 Digital tools" ,"🔆 Customized apps","🔆 More web resources"])
    ...
    with tab2:
        ...
        st.markdown("#### Note: The following only displays wordlist in text. To use audio sound, click the application button 'Go to Voca Application' in the above.")
